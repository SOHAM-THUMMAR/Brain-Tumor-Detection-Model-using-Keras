...
def generate_dfd_level0_svg():
    ...
    output_path = os.path.join(docs_dir, "dfd_level0.svg")
    plt.savefig(output_path, format='svg', facecolor=fig.get_facecolor(), bbox_inches='tight')
    plt.close()
    print(f"Successfully generated SVG: {output_path}")

def generate_dfd_level1_svg():
    ...
    output_path = os.path.join(docs_dir, "dfd_level1.svg")
    plt.savefig(output_path, format='svg', facecolor=fig.get_facecolor(), bbox_inches='tight')
    plt.close()
    print(f"Successfully generated SVG: {output_path}")
...
def generate_er_diagram_svg():
    ...
    output_path = os.path.join(docs_dir, "er_diagram.svg")
    plt.savefig(output_path, format='svg', facecolor=fig.get_facecolor(), bbox_inches='tight')
    plt.close()
    print(f"Successfully generated SVG: {output_path}")

def generate_class_architecture_svg():
    ...
    output_path = os.path.join(docs_dir, "class_architecture.svg")
    plt.savefig(output_path, format='svg', facecolor=fig.get_facecolor(), bbox_inches='tight')
    plt.close()
    print(f"Successfully generated SVG: {output_path}")

def generate_object_interaction_diagram_svg():
    ...
    output_path = os.path.join(docs_dir, "object_interaction_diagram.svg")
    plt.savefig(output_path, format='svg', facecolor=fig.get_facecolor(), bbox_inches='tight')
    plt.close()
    print(f"Successfully generated SVG: {output_path}")

def generate_control_flow_diagram_svg():
    ...
    output_path = os.path.join(docs_dir, "control_flow_diagram.svg")
    plt.savefig(output_path, format='svg', facecolor=fig.get_facecolor(), bbox_inches='tight')
    plt.close()
    print(f"Successfully generated SVG: {output_path}")
...
def generate_sequence_diagram_svg():
    ...
    output_path = os.path.join(docs_dir, "sequence_diagram.svg")
    plt.savefig(output_path, format='svg', facecolor=fig.get_facecolor(), bbox_inches='tight')
    plt.close()
    print(f"Successfully generated SVG: {output_path}")

if __name__ == "__main__":
    generate_dfd_level0_svg()
    generate_dfd_level1_svg()
    generate_er_diagram_svg()
    generate_class_architecture_svg()
    generate_object_interaction_diagram_svg()
    generate_control_flow_diagram_svg()
